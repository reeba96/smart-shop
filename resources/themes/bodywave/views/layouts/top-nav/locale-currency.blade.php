{!! view_render_event('bagisto.shop.layout.header.locale.before') !!}
    ...
    <div class="pull-left">
        <h4>
            <button class="btn btn-secondary btn-lg"><i class="rango-phone"></i> Kontakt tel:</button>
            <a href="tel:+38166462444">
                <button class="btn btn-primary btn-lg">+1 00 000-000</button>
            </a>
        </h4>
        {{-- <div class="dropdown">
