                        ...
                        <div class="wrapper" v-if="this.rootCategories">
                            ...
                            @auth('customer')
                                <ul type="none" class="vc-customer-options">
                                    ...
                                    <li>
                                        <a href="{{ route('customer.helpdesk.index') }}" class="unset">
                                            <i class="icon downloadables text-down-3"></i>
                                            <span>{{ __('velocity::app.shop.general.downloadables') }}</span>
                                        </a>
                                    </li>
                            ...
                            <ul type="none" class="meta-wrapper">
                                ...
                                <li>
                                    <button class="btn btn-secondary btn-lg"><i class="rango-phone"></i></button>
            
                                    <a href="tel:+38124793541">
                                        <button class="btn btn-primary btn-lg">+38124793541</button>
                                    </a>
                        
                                    <a href="tel:+38124792662">
                                        <button class="btn btn-primary btn-lg">+38124792662</button>
                                    </a>                                
                                </li>
