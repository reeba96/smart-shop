...
@section('content') 
    ...
    <div class="content">
        <form method="POST" action="{{ route('admin.helpdesk.priority.store') }}" @submit.prevent="onSubmit" enctype="multipart/form-data">
                    ...
                    <accordian :title="'{{ __('helpdesk::admin.general') }}'" :active="true">
                        <div slot="body">
                            ...
                            <div class="control-group" :class="[errors.has('name') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required'" class="control" id="name" name="name" value="{{ old('name') }}" data-vv-as="&quot;{{ __('helpdesk::admin.status-create-name') }}&quot;" v-slugify-target="'slug'"/>
