...
@section('page', trans('helpdesk::admin.index-title'))
...
@section('ticketit_extra_content')
            ...
            <div class="card bg-light">
                <div class="card-body row d-flex align-items-center">
                    ...
                    <div class="col-9 text-right">
                        <h1>{{ $tickets_count }}</h1>
                        <div>{{ trans('helpdesk::admin.index-total-tickets') }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="card bg-danger">
                <div class="card-body row d-flex align-items-center">
                    ...
                    <div class="col-9 text-right">
                        ...
                        <div>{{ trans('helpdesk::admin.index-open-tickets') }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="card bg-success">
                <div class="card-body row d-flex align-items-center">
                    ...
                    <div class="col-9 text-right">
                        ...
                        <span>{{ trans('helpdesk::admin.index-closed-tickets') }}</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-8 mt-3">
                <div class="card ">
                    <div class="card-header d-flex justify-content-between align-items-baseline flex-wrap">
                        <div><i class="fas fa-chart-bar fa-fw"></i> {{ trans('helpdesk::admin.index-performance-indicator') }}</div>
                        <div class="btn-group">
                            <button type="button" class="btn btn-secondary btn-sm dropdown-toggle" data-toggle="dropdown">
                                {{ trans('helpdesk::admin.index-periods') }}
                                <span class="caret"></span>
                            </button>
                            <div class="dropdown-menu" role="menu">
                                <a class="dropdown-item" href="{{ action('\ICBTECH\Helpdesk\Http\Controllers\DashboardController@index', 2) }}">
                                    {{ trans('helpdesk::admin.index-3-months') }}
                                </a>
                                <a class="dropdown-item" href="{{ action('\ICBTECH\Helpdesk\Http\Controllers\DashboardController@index', 5) }}">
                                    {{ trans('helpdesk::admin.index-6-months') }}
                                </a>
                                <a class="dropdown-item" href="{{ action('\ICBTECH\Helpdesk\Http\Controllers\DashboardController@index', 11) }}">
                                    {{ trans('helpdesk::admin.index-12-months') }}
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-deck mt-3">
                    <div class="card ">
                        <div class="card-header">
                            {{ trans('helpdesk::admin.index-tickets-share-per-category') }}
                        </div>
                        <div class="panel-body">
                    ...
                    <div class="card ">
                        <div class="card-header">
                            {{ trans('helpdesk::admin.index-tickets-share-per-agent') }}
                        </div>
                        <div class="panel-body">
                ...
                <div class="tab-content">
                    <div id="information-panel-categories" class="list-group tab-pane fade {{$active_tab == "cat" ? "show active" : ""}}">
                        <a href="#" class="list-group-item list-group-item-action disabled">
                            <span>{{ trans('helpdesk::admin.index-category') }}
                                <span class="badge badge-pill badge-secondary">{{ trans('helpdesk::admin.index-total') }}</span>
                            </span>
                            <small class="pull-right text-muted">
                                <em>
                                    {{ trans('helpdesk::admin.index-open') }} /
                                     {{ trans('helpdesk::admin.index-closed') }}
                                </em>
                            </small>
                        </a>
                    ...
                    <div id="information-panel-agents" class="list-group tab-pane fade {{$active_tab == "agents" ? "show active" : ""}}">
                        <a href="#" class="list-group-item list-group-item-action disabled">
                            <span>{{ trans('helpdesk::admin.index-agent') }}
                                <span class="badge badge-pill badge-secondary">{{ trans('helpdesk::admin.index-total') }}</span>
                            </span>
                            <span class="pull-right text-muted small">
                                <em>
                    ...
                    <div id="information-panel-users" class="list-group tab-pane fade {{$active_tab == "users" ? "show active" : ""}}">
                        <a href="#" class="list-group-item list-group-item-action disabled">
                            <span>{{ trans('helpdesk::admin.index-user') }}
                                <span class="badge badge-pill badge-secondary">{{ trans('helpdesk::admin.index-total') }}</span>
                            </span>
                            <span class="pull-right text-muted small">
                                <em>
    ...
    @else
        <div class="card text-center">
            {{ trans('helpdesk::admin.index-empty-records') }}
        </div>
    @endif
@stop
@section('footer')
    @if($tickets_count)
    {{--@include('helpdesk::shared.footer')--}}
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            var data = google.visualization.arrayToDataTable([
                ["{{ trans('helpdesk::admin.index-month') }}", "{!! implode('", "', $monthly_performance['categories']) !!}"],
            ...
            var options = {
                title: '{!! addslashes(trans('helpdesk::admin.index-performance-chart')) !!}',
                curveType: 'function',
            ...
            var cat_data = google.visualization.arrayToDataTable([
              ['{{ trans('helpdesk::admin.index-category') }}', '{!! addslashes(trans('helpdesk::admin.index-tickets')) !!}'],
            ...
            var cat_options = {
              title: '{!! addslashes(trans('helpdesk::admin.index-categories-chart')) !!}',
            ...
            var agent_data = google.visualization.arrayToDataTable([
              ['{{ trans('helpdesk::admin.index-agent') }}', '{!! addslashes(trans('helpdesk::admin.index-tickets')) !!}'],
            ...
            var agent_options = {
              title: '{!! addslashes(trans('helpdesk::admin.index-agents-chart')) !!}',
              legend: {position: 'bottom'}
            };
