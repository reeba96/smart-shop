...
<div class="container">
    <h1 style="text-align: center">{{ trans('helpdesk::install.upgrade') }}</h1>
    <br>
    ...
    <div class="well small" style="border: 1px solid #ccc">
        @if(!empty($inactive_settings))
            <b>{{ trans('helpdesk::install.settings-to-be-installed') }}</b>
            <ul>
        ...
        @else
            <b>{{ trans('helpdesk::install.all-settings-installed') }}</b>
        @endif
    </div>
    <br>
