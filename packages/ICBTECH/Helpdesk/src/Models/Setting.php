...
use ICBTECH\Helpdesk\Models\Setting as Table;
...
class Setting extends Model
{
    ...
    public static function grab($slug)
    {
        ...
        $setting = Cache::remember('helpdesk::settings.'.$slug, $time, function () use ($slug, $time) {
            $settings = Cache::remember('helpdesk::settings', $time, function () {
                return Table::all();
            });
