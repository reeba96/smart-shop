...
class SettingsTableSeeder extends Seeder
{
    ...
    public function getDefaults()
    {
        return [
             ...
             * Default: helpdesk::emails.templates.ticketit
             */
            'email.template' => 'helpdesk::emails.templates.ticketit',
...
//            'admin_ids' => [1],
             ...
             */
            'summernote_options_json_file' => 'ICBTECH/Helpdesk/src/JSON/summernote_init.json',
             ...
             */
            'routes' => base_path('Webkul/Shop/src/Http').'/routes.php',
