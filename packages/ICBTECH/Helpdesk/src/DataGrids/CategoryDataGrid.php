...
class CategoryDataGrid extends DataGrid
{
    ...
    {
        $queryBuilder = DB::table('ticketit_categories');
    ...
    { 
        $this->addAction([
            ...
            'method' => 'GET',
            'route'  => 'admin.helpdesk.category.edit',
        ...
        $this->addAction([
            ...
            'method' => 'POST',
            'route'  => 'admin.helpdesk.category.delete',
    ...
    public function prepareMassActions()
    {
        $this->addMassAction([
            'type'   => 'delete',
            'action' => route('admin.helpdesk.category.massdelete'),
