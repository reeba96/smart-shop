...
class AdministratorsController extends Controller
{
    public function index()
    {
        ...
        return view('helpdesk::admin.administrator.index', compact('administrators'));
    }
    ...
    public function create()
    {
        ...
        return view('helpdesk::admin.administrator.create', compact('users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        Session::flash('status', trans('helpdesk::lang.administrators-are-added-to-administrators', ['names' => $administrators_names]));

        return redirect()->action('\ICBTECH\Helpdesk\Http\Controllers\AdministratorsController@index');
    }
    ...
    public function update($id, Request $request)
    {
        ...
        Session::flash('status', trans('helpdesk::lang.administrators-joined-categories-ok'));
    ...
    public function destroy($id)
    {
        ...
        Session::flash('status', trans('helpdesk::lang.administrators-is-removed-from-team', ['name' => $administrator->name]));
