...
class AgentsController extends Controller
{
    ...
    {
        return view('helpdesk::admin.agent.index');
    }
    ...
    public function create()
    {
        ...
        return view('helpdesk::admin.agent.create', compact('users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        Session::flash('status', trans('helpdesk::lang.agents-are-added-to-agents', ['names' => $agents_names]));

        return redirect()->action('\ICBTECH\Helpdesk\Http\Controllers\AgentsController@index');
    }
    ...
    public function update($id, Request $request)
    {
        ...
        Session::flash('status', trans('helpdesk::lang.agents-joined-categories-ok'));
    ...
    public function destroy($id)
    {
        ...
        Session::flash('status', trans('helpdesk::lang.agents-is-removed-from-team', ['name' => $agent->name]));
