...
return [
    [
        ...
        'key'        => 'helpdesk',
        'name'       => 'admin::app.layouts.helpdesk',
        ...
        'key'        => 'helpdesk.complete',
        'name'       => 'admin::app.layouts.helpdesk',
        'route'      => 'admin.helpdesk.index.complete',
        'sort'       => 3,
        'icon-class' => '',
    ], [
        'key'        => 'helpdesk.status',
        ...
        'name'       => 'admin::app.layouts.helpdesk',
        'route'      => 'admin.helpdesk.category.index',
        'sort'       => 5,
        'icon-class' => '',
    ], [
        'key'        => 'helpdesk.configuration',
        'name'       => 'admin::app.layouts.helpdesk',
